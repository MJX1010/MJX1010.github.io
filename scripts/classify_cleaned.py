...
TARGETS: dict[str, dict] = {
    "ai-tail": {"file": "AI/工具与导航/AI工具与导航.md", "section": "## 补充资料", "append": True, "tags_add": []},
    "unity-tail": {"file": "游戏/引擎/Unity/Unity-框架与工具.md", "section": "## 补充资料", "append": True, "tags_add": []},
    "unreal-tail": {"file": "游戏/引擎/Unreal/Unreal-Engine.md", "section": "## 补充资料", "append": True, "tags_add": []},
    "framesync-tail": {"file": "游戏/玩法与系统/帧同步与游戏AI.md", "section": "## 补充资料", "append": True, "tags_add": ["补充资料"]},
    "game-mobile-tail": {"file": "游戏/平台与发行/移动端接入与平台问题.md", "section": "## 补充资料", "append": True, "tags_add": ["补充资料"]},
    "cs-ref-tail": {"file": "计算机/语言与运行时/C-CSharp-CPP参考.md", "section": "## 补充资料", "append": True, "tags_add": ["补充资料"]},
    "github-tail": {"file": "计算机/基础与规范/平台与规范.md", "section": "## 补充资料", "append": True, "tags_add": []},
    "blog-tail": {"file": "资讯/社区与博客/技术博客与社区.md", "section": "## 补充资料", "append": True, "tags_add": []},
    "video-tail": {"file": "资讯/视频与课程/视频与课程.md", "section": "## 补充资料", "append": True, "tags_add": ["补充资料"]},
    "tools-tail": {"file": "工具/在线协作/在线工具与协作.md", "section": "## 补充资料", "append": True, "tags_add": ["补充资料"]},
    "proxy-tail": {"file": "工具/网络与连接/网络与代理.md", "section": "## 补充资料", "append": True, "tags_add": ["补充资料"]},
